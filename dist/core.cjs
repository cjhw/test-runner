"use strict";Object.defineProperty(exports, "__esModule", {value: true});// lib/core.ts
var tests = [];
var onlys = [];
var beforeAlls = [];
var beforeEachs = [];
...
exports.afterAll = afterAll; exports.afterEach = afterEach; exports.beforeAll = beforeAll; exports.beforeEach = beforeEach; exports.describe = describe; exports.expect = expect; exports.it = it; exports.run = run; exports.test = test;
